...
export const Border: React.FC<Props> = ({ keyName }) => {
  ...
  return (
    ...
    >
      <option selected={block()?.attrs[keyName] === ""} value="main-text">
        Empty definition
      </option>

      <option selected={block()?.attrs[keyName] === "border"} value="border">
        Border
      </option>
      ...
      <option
        selected={block()?.attrs[keyName] === "border-b"}
        value="border-b"
      >
        Border bottom
      </option>
      ...
      <option
        selected={block()?.attrs[keyName] === "border-l"}
        value="border-l"
      >
        Border left
      </option>
      ...
      <option
        selected={block()?.attrs[keyName] === "border-t"}
        value="border-t"
      >
        Border top
      </option>
