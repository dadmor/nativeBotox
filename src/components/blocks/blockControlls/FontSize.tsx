...
export const FontSize: React.FC<Props> = ({ keyName }) => {
  ...
  return (
    ...
    >
      ...
      <option selected={block()?.attrs[keyName] === "text-xs"} value="text-xs">
        Extra small (XS)
      </option>
      <option selected={block()?.attrs[keyName] === "text-sm"} value="text-sm">
        Small (S)
      </option>
      <option selected={block()?.attrs[keyName] === "text-lg"} value="text-lg">
        Large (L)
      </option>
      <option selected={block()?.attrs[keyName] === "text-xl"} value="text-xl">
        Extra Large (XL)
      </option>
      <option
